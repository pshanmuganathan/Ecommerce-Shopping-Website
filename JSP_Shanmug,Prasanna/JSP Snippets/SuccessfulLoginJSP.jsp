...
<br />
 <table style="width=1001px; height=1001px;" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
    ...
    <tr>
      ...
      <div class="logo"><a href="index.html"><span class="style5">BEST<br />
    DEAL</span></a></div>
      </div></td>
<td colspan="3"><div class="style1" id="header">
      <br />
      ONLINE <span class="style3">STORE</span>
             <span class="style4"><br />
             Seek. Find. Enjoy                       </span></div></td>
        <td>
    ...
    <tr>
      ...
      <ul>
      <li><a href="/csj/TrendFinal">TRENDS</a></li>
      <li><a href="index.html">LOGOUT</a></li>
      <li><a href="/csj/ViewCartFinal">CART</a></li>
      <li><a href="CancelOrderFinal.html">CANCEL</a></li>
    ...
    <tr>
      ...
      <div class="title">WELCOME DEAR             </div>
      <div class=" content" >
    ...
    <tr>
      ...
      <td><div class="left_menu">
        ...
        <li><a href="/csj/SAXParserProductsFinal?param=Phone">SMART PHONE</a></li>
        <li><a href="/csj/SAXParserProductsFinal?param=Tablets">TABLETS</a></li>
        <li><a href="/csj/SAXParserProductsFinal?param=Laptop">LAPTOPS</a></li>
        <li><a href="/csj/SAXParserProductsFinal?param=TV">TELEVISION</a></li>
