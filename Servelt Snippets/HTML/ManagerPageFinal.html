...
<td colspan="3"><div class="style1" id="header">
    ...
    <tr>
      ...
      <ul>
      <li><a href="StorageManagerPage.html">HOME</a></li>
      <li><a href="Login.html">LOGOUT</a></li>
      <li><a href="index.html">CART</a></li>
      <li><a href="AddProduct.html">CONTACT</a></li>
      </ul>
      </div></td>
	    <td colspan="2">
    ...
    <tr>
      ...
      <div class="title">WELCOME DEAR MANAGER</div>
      <div class=" content">
    ...
    <form method="post" action="DeleteProductFinal.html">
       <table cellpadding='2' cellspacing='1'>
    ...
    <tr>
      ...
      <td><div class="left_menu">
        ...
        <li><a href="index.html">SMART PHONE</a></li>
